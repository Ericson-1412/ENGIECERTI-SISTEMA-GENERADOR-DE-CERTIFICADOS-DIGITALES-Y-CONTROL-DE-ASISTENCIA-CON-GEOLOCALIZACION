                ...
                <div class="modal-body pd-25">
                        ...
                        <div class="col-log-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="inst_sex" id="inst_sex" data-placeholder="Seleccione" required>
                        ...
                        <div class="col-log-12">
                            <div class="form-group">
                                ...
                                <input class="form-control tx-uppercase" id="isnt_telf" type="text" name="isnt_telf" required />
                            </div>
                        </div>       
                </div>
