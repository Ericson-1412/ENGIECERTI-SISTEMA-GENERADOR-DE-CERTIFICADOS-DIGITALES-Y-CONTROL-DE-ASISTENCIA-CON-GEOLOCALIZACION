                ...
                <div class="modal-body pd-25">
                        ...
                        <div class="col-log-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cat_id" id="cat_id" data-placeholder="Seleccione" required>
                        ...
                        <div class="col-log-12">
                            <div class="form-group">
                                <label class="form-control-label">Descripcion: 
                                    <span class="tx-danger">*</span>
                                </label>
                        ...
                        <div class="col-log-12">
                            <div class="form-group">
                                <label class="form-control-label">Fecha Inicio: 
                                    <span class="tx-danger">*</span>
                                </label>
                        ...
                        <div class="col-log-12">
                            <div class="form-group">
                                <label class="form-control-label">Fecha Fin: 
                                    <span class="tx-danger">*</span>
                                </label>
                        ...
                        <div class="col-log-12">
                            <div class="form-group">
                                <label class="form-control-label">Instructor: 
                                    <span class="tx-danger">*</span>
                                </label>
                                <select class="form-control" name="inst_id" id="inst_id" data-placeholder="Seleccione" required>
                                    <option value="" disabled selected>Seleccione</option>
                                </select>
                            </div>
                        </div>
