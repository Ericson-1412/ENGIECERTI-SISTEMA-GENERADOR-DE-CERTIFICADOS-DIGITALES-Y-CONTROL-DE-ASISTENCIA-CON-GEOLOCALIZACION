<?php
    class Instructor extends Conectar{
        ...
        public function insert_instructor($inst_nom, $inst_apep, $inst_apem, $inst_correo, $inst_sex, $isnt_telf) {
            $conectar = parent::conexion();
            parent::set_names();
            $sql = "INSERT INTO tm_instructor (inst_id, inst_nom, inst_apep, inst_apem, inst_correo, inst_sex, isnt_telf, fech_crea, est) VALUES (NULL,?,?,?,?,?,?, now(),'1');";
            ...
            $sql->bindValue(6, $isnt_telf);
            $sql->execute();
            return $resultado=$sql->fetchAll();
        }

        public function update_instructor($inst_id, $inst_nom, $inst_apep, $inst_apem, $inst_correo, $inst_sex, $isnt_telf){
            $conectar = parent::conexion();
            parent::set_names();
